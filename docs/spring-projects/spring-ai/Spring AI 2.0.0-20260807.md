...
## description
## changes
For upgrading from 1.1.x to 2.0.0, please refer to the upgrade notes <a href="https://docs.spring.io/spring-ai/reference/upgrade-notes.html#upgrading-to-2-0-0" rel="nofollow">here</a>.
