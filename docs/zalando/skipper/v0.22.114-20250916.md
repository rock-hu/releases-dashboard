...
build(deps): bump amazonlinux from <code>f507795</code> to <code>4f02d5d</code> in /fuzz (<a class="issue-link js-issue-link" data-error-text="Failed to load title" data-id="3415785881" data-permission-text="Title is private" data-url="https://github.com/zalando/skipper/issues/3624" data-hovercard-type="pull_request" data-hovercard-url="/zalando/skipper/pull/3624/hovercard" href="https://github.com/zalando/skipper/pull/3624">#3624</a>)

Bumps amazonlinux from <code>f507795</code> to <code>4f02d5d</code>.
...
Multiarch Docker image is available in Github's docker registry:
    ...
    docker run -it ghcr.io/zalando/skipper:v0.22.114 skipper --help

Docker image

Docker image is available in Zalando's Open Source registry:

    docker run -it registry.opensource.zalan.do/teapot/skipper:v0.22.114 skipper --help
