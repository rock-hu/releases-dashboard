...
build(deps): bump amazonlinux from <code>4729578</code> to <code>d6b42a9</code> in /fuzz (<a class="issue-link js-issue-link" data-error-text="Failed to load title" data-id="3328845479" data-permission-text="Title is private" data-url="https://github.com/zalando/skipper/issues/3593" data-hovercard-type="pull_request" data-hovercard-url="/zalando/skipper/pull/3593/hovercard" href="https://github.com/zalando/skipper/pull/3593">#3593</a>)

Bumps amazonlinux from <code>4729578</code> to <code>d6b42a9</code>.
...
Multiarch Docker image is available in Github's docker registry:
    ...
    docker run -it ghcr.io/zalando/skipper:v0.22.89 skipper --help

Docker image

Docker image is available in Zalando's Open Source registry:

    docker run -it registry.opensource.zalan.do/teapot/skipper:v0.22.89 skipper --help
