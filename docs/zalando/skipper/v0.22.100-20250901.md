...
build(deps): bump amazonlinux from <code>d6b42a9</code> to <code>f507795</code> in /fuzz (<a class="issue-link js-issue-link" data-error-text="Failed to load title" data-id="3370870428" data-permission-text="Title is private" data-url="https://github.com/zalando/skipper/issues/3607" data-hovercard-type="pull_request" data-hovercard-url="/zalando/skipper/pull/3607/hovercard" href="https://github.com/zalando/skipper/pull/3607">#3607</a>)

Bumps amazonlinux from <code>d6b42a9</code> to <code>f507795</code>.
...
Multiarch Docker image is available in Github's docker registry:
    ...
    docker run -it ghcr.io/zalando/skipper:v0.22.100 skipper --help

Docker image

Docker image is available in Zalando's Open Source registry:

    docker run -it registry.opensource.zalan.do/teapot/skipper:v0.22.100 skipper --help
