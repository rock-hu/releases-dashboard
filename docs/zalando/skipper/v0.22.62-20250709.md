...
build(deps): bump amazonlinux from <code>a72ad02</code> to <code>54064c8</code> in /fuzz (<a class="issue-link js-issue-link" data-error-text="Failed to load title" data-id="3166397847" data-permission-text="Title is private" data-url="https://github.com/zalando/skipper/issues/3536" data-hovercard-type="pull_request" data-hovercard-url="/zalando/skipper/pull/3536/hovercard" href="https://github.com/zalando/skipper/pull/3536">#3536</a>)

Bumps amazonlinux from <code>a72ad02</code> to <code>54064c8</code>.
...
Multiarch Docker image is available in Github's docker registry:
        ...
        docker run -it ghcr.io/zalando/skipper:v0.22.62 skipper --help

Docker image

Docker image is available in Zalando's Open Source registry:

        docker run -it registry.opensource.zalan.do/teapot/skipper:v0.22.62 skipper --help
