...
• Initialization procedure was incorrectly reported as having been simplified in this version, i.e. version 1.5.20 by removing the step instantiating a <code>SerializedModelConfigurator</code>. The actual simplification was done in version 1.5.21
